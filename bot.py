...
pyrogram.utils.MIN_CHANNEL_ID = -1001992049478

# Setting SUPPORT_CHAT directly here
SUPPORT_CHAT = int(os.environ.get("SUPPORT_CHAT", "-1001940015888"))
            ...
            try:
                ...
                await self.send_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/KR_Movie2")
                        ]]
                    )
                )
